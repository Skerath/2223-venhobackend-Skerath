...
module.exports = {
    up: async (knex) => {
        await knex.schema.createTable(resourcesTables.resources, (table) => {
        ...
        await knex.schema.createTable(resourcesTables.itemIdentifiers, (table) => {
        ...
        await knex.schema.createTable(resourcesTables.consumableIdentifiers, (table) => {
        ...
        await knex.schema.createTable(resourcesTables.ingredientPositionModifier, (table) => {
